        ...
        <main>
            ...
            <div class="container-fluid px-4">
                ...
                <div class="card mb-4">
                    ...
                    <table style="width:30%;" class="datatable-table table-align-center">
                        ...
                        <tbody id="userList" class="table-group-divider">
                            ...
                            <tr>
                                <td style="width:35%;" >활동</td>
                                <td style="width:35%;">비활동</td>
                                <td style="background-color:  #e9ecef">합계</td>
                                <!-- <td><input style="width:100%;" type="text" name="userId" value = "${user.userId}" readonly></td> -->
                            </tr>
                            <tr>
                                
                                <td >${activeUserCount}</td>
                                <td>${deactivatedUserCount}</td>
                                <td style="background-color:  #e9ecef">${userCount}</td>
